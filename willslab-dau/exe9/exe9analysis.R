...
print("Note: Slightly different absolute values than reported in paper")
print("See notes in analysis file for explanation")
# Note: Although it does not affect the conclusions, the absolute figures
# presented here are slightly different to those reported in Wills et al.
# (2013, Experiment 4). This is a minor reporting error in the paper.
# Due to a technical error, the paper analysis considered only the first six of the
# 8 blocks in this experiment.
