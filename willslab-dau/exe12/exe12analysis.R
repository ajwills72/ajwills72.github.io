...
print('Andy Wills')
print('')
print('DAU: EXE12 by Andy Wills is licensed under a Creative Commons')
...
# Load data file
dta <- read.table('exe12data.csv',header=T,sep=",",as.is=T)
...
print('')
print('Removing participants 7,11')
print('')
dta <- dta[dta$subj != 7,]
dta <- dta[dta$subj != 11,]
ph2dta <- ph2dta[ph2dta$subj != 7,]
ph2dta <- ph2dta[ph2dta$subj != 11,]
