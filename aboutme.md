...
- **Ghost writing**. Back in around 2002, I did some ghost writing for Brown PartWorks, which ended up in a six-volume psychology textbook published by Grolier. They ended up mashing up text from various anonymous authors into chapters, and weren't that responsive to feedback that some of the information was wrong. The [Representing Information](/assets/pdf/representing-information.pdf) chapter is somewhat close to what I wrote, and about 30% of the [Behaviorism](/assets/pdf/behaviorism.pdf) chapter is related to what I wrote.
